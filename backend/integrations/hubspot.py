...
CLIENT_ID = "44260a9c-a749-4278-b555-684a868264f2"
CLIENT_SECRET = "b4cd0515-d5c1-48a2-80eb-08118c2c7239"
REDIRECT_URI = 'http://localhost:8000/integrations/hubspot/oauth2callback'
SCOPE = 'crm.objects.contacts.write%20oauth%20crm.objects.companies.write%20crm.objects.companies.read%20crm.objects.contacts.read'
...
async def authorize_hubspot(user_id, org_id):
    ...
    auth_url = f'https://app.hubspot.com/oauth/authorize?client_id={CLIENT_ID}&scope={SCOPE}&redirect_uri={REDIRECT_URI}&state={encoded_state}'
...
def create_integration_item_metadata_object(response_json) -> IntegrationItem:
    contact_integration_item_metadata = IntegrationItem(
        id=response_json.get('id', None),
        type='contact',  # Specifying this is a contact type
